...
# abbreviations
ab_authors = u'Xiaohao Yang, Simon J.L. Billinge group'
...
copyright = u'%Y, Columbia University'
...
latex_documents = [
  ('index', 'srxplanar_manual.tex', u'srxplanar Documentation',
   ab_authors, 'manual'),
]
...
man_pages = [
    ('index', 'srxplanar', u'srxplanar Documentation',
     ab_authors, 1)
]
...
texinfo_documents = [
  ('index', 'srxplanar', u'srxplanar Documentation',
   ab_authors, 'srxplanar', 'One line description of project.',
   'Miscellaneous'),
]
